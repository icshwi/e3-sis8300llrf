...
epicsEnvSet("LLRF_PULSETYPE" "$(SIS8300LLRF_PULSETYPE=1)")
...
dbLoadRecords("sis8300llrf-SpecOp.db", "PREFIX=$(LLRF_PREFIX), ASYN_PORT=$(LLRF_PORT), PULSE_TYPE=$(LLRF_PULSETYPE), NUM_PULSE_TYPES=$(LLRF_NOPULSETYPES), FF_SMNM_MAX = 0x1000, SP_SMNM_MAX = 0x100000")
